...
import { FiBriefcase, FiUsers, FiEdit2, FiTrash2, FiPlus, FiSearch } from 'react-icons/fi';
          ...
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-200/60">
                ...
                className="flex items-center space-x-2 px-4 py-2 text-blue-700 hover:bg-blue-50 rounded-xl transition-colors duration-200">
