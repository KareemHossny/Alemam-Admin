      ...
      <div className="flex justify-center items-center py-8 sm:py-12">
        <div className="text-center">
          ...
          <button 
            ...
            className="bg-purple-600 hover:bg-purple-700 text-white px-4 sm:px-6 py-2 rounded-xl font-semibold text-sm sm:text-base"
          >
            Try Again
          </button>
        </div>
  ...
  return (
    <div className="max-w-6xl mx-auto w-full px-2 sm:px-4">
      ...
      <div className="flex items-center justify-between mb-6 sm:mb-8">
        <div>
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800">View Tasks</h1>
          <p className="text-gray-600 text-sm sm:text-base">View your daily or monthly tasks</p>
        </div>
        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-purple-600 to-purple-700 rounded-xl sm:rounded-2xl flex items-center justify-center text-white shadow-lg">
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="space-y-2 sm:space-y-3">
                <Link
                  to={`/engineer/view-daily-tasks/${project._id}`}
                  className="flex items-center justify-center gap-2 w-full p-2 sm:p-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg sm:rounded-xl transition-colors font-semibold text-xs sm:text-sm"
                >
                ...
                <Link
                  to={`/engineer/view-monthly-tasks/${project._id}`}
